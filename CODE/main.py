...
if __name__ == "__main__":
    video_path = "D:\BE Final Year Project\India Vs South Africa.mp4"
    extracted_frame_dir = "D:\BE Final Year Project\workspace\output\extracted_frames"
    ...
    # frame_extractor.extract_frames_by_percentage(1)
    # print("Frames extracted successfully.")

    # #finding Scoreboard using yolo
    # model_path = r'D:\BE Final Year Project\workspace\model\best.pt'
